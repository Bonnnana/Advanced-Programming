...
class ComplexNumber<T extends Number, U extends Number> implements Comparable<ComplexNumber> {
    ...
    public double modul() {
        ...
        double imgPart = imaginary.doubleValue();
    ...
    public String toString() {
        ...
        String realString = String.format("%.2f", realPart);
        String imgString = String.format("%.2fi", imgPart);

        if (imgPart >= 0)
            return realString + "+" + imgString;
        else
            return realString + imgString;
